...
public partial class ApplicationDbContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Server=.;Database=Indpro;Trusted_Connection=True;MultipleActiveResultSets=true;Trusted_Connection=true;TrustServerCertificate=True");
